...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-CNVgybii.js
...
function getInstantWellWorkAnswer(question, locale) {
...
createServerFn({ method: "POST" }).validator(validateRequest).handler(createSsrRpc("430e01e763efe192deeadcd55a5535f2aa833377fa2bc9d5bb9171143218ec3d"));
var wellwork_assistant_mascot_default = "/assets/wellwork-assistant-mascot-BeyclNtP.png";
function MascotAvatar({ size = "header", greeting = false }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
		className: `wellwork-mascot relative inline-grid shrink-0 place-items-center ${size === "launcher" ? "h-14 w-14" : size === "message" ? "h-9 w-9" : "h-12 w-12"}`,
		"aria-hidden": "true",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
				src: wellwork_assistant_mascot_default,
				alt: "",
				className: `wellwork-mascot-character h-full w-full object-contain ${greeting ? "wellwork-mascot-greeting" : ""}`
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "wellwork-mascot-shadow" }),
			size !== "message" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "wellwork-mascot-sparkle" })
		]
	});
}
var copy = {
...
function WellWorkChatbot() {
	...
	const visibleMessages = (0, import_react.useMemo)(() => messages.length === 0 ? [greeting] : messages, [greeting, messages]);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnimatePresence, { children: open && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.section, {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-y-0 end-0 w-28 bg-leaf/15" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MascotAvatar, { greeting: true }),
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							visibleMessages.map((message) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [message.role === "assistant" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MascotAvatar, { size: "message" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MascotAvatar, { size: "launcher" }),
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "max-w-7xl mx-auto grid grid-cols-[1fr_auto] items-center gap-x-2 px-4 pb-12 pt-2 sm:flex sm:h-16 sm:px-6 sm:py-0 md:h-20 md:justify-between md:gap-x-6 md:px-8",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							to: "/",
							className: "flex min-w-0 items-center gap-2 group sm:gap-2.5 md:shrink-0",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
							className: "hidden md:flex min-w-0 flex-1 items-center justify-center gap-4 text-sm font-medium text-muted-foreground lg:gap-8",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
									href: "#platform",
									className: "whitespace-nowrap px-2 py-2 hover:text-foreground transition",
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DropdownMenu, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DropdownMenuTrigger, {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
										variant: "ghost",
										size: "icon",
										className: "h-9 w-9 text-muted-foreground hover:text-foreground sm:w-auto sm:gap-1.5 sm:px-2 md:h-10 md:px-3",
								...
								user ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
										className: "gradient-brand h-9 w-full rounded-full border-0 px-5 text-white shadow-elegant sm:h-10 sm:w-auto md:h-11 md:px-6 md:whitespace-nowrap",
										children: "Tableau de bord"
									})
								}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
									to: "/auth",
									className: "hidden whitespace-nowrap px-3 py-2 text-sm font-medium transition-colors hover:text-brand sm:inline-flex md:px-4",
									children: t("landingLogin")
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
									to: "/auth",
									className: "absolute left-4 right-4 top-[3.25rem] sm:static",
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
										className: "gradient-leaf h-9 w-full rounded-full border-0 px-5 text-sm text-white shadow-elegant sm:h-10 sm:w-auto md:h-11 md:px-6 md:whitespace-nowrap",
										children: [
											t("landingDemoBtn"),
											" ",
