...
import { i as useMySpace, n as useAuth, r as useManagerPermissions, t as hasRole } from "./useAuth-jrEiK_TF.mjs";
...
import { t as MobileNavigation } from "./MobileNavigation-Cv3Ozks1.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/AppShell-Cbba_P6U.js
...
function Sidebar() {
	...
	const { info } = useMySpace();
	const [anonymousCount, setAnonymousCount] = (0, import_react.useState)(null);
	...
	(0, import_react.useEffect)(() => {
		...
		const loadCount = async () => {
			const { count, error } = await supabase.from("feedback_tickets").select("id", {
				count: "exact",
				head: true
			}).eq("space_id", spaceId);
		...
		loadCount();
		const channel = supabase.channel(`sidebar-feedback-${spaceId}`).on("postgres_changes", {
			event: "*",
			schema: "public",
			table: "feedback_tickets",
			filter: `space_id=eq.${spaceId}`
		}, () => void loadCount()).subscribe();
		return () => {
			mounted = false;
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
			...
			children: [items.map((item) => {
				...
				const badge = item.to === "/admin/anonymous" && anonymousCount !== null ? String(anonymousCount) : item.badge;
				return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
					...
					children: [
						...
						!isSidebarCollapsed && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							className: `relative z-10 text-[10px] font-bold px-1.5 py-0.5 rounded-full ${badge === "!" ? "bg-danger text-white" : "bg-white/20 text-white"}`,
							children: badge
						})] })
					]
				}, item.to);
