...
import { Ct as Check, bt as ChevronRight, ut as Copy, xt as ChevronLeft } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/employee.surveys-DlzTzwXv.js
...
function SurveysPage() {
	...
	const [refCode] = (0, import_react.useState)(() => "REF-" + Math.random().toString(36).slice(2, 7).toUpperCase());
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: pick("Conservez ce code pour suivre la réponse RH.", "احفظ هذا الرمز لتتبع رد الإدارة.", "Save this code to track HR's reply.")
				})
			]
		})
	})] });
