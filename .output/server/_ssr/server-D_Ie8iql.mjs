...
import { n as getResponse, r as requestHandler } from "./server-DuGX_xsT.mjs";
import { t as createMiddleware } from "./createMiddleware-B_4t7rW1.mjs";
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-c34I1AjL.mjs";
require_react();
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CcVLjKxY.mjs");
