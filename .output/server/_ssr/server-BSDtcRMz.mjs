...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-zF1kppnj.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DkbGOt3O.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DXrCEorD.mjs"),
		import("./start-DIP3mi70.mjs"),
...
//#endregion
export { requestHandler as a, createServerEntry, server_default as default, getResponse as i, HEADERS as n, defaultStreamHandler as o, getRequest as r, StartServer as s, createStartHandler as t };
