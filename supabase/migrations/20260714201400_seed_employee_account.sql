...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM auth.users WHERE email = 'employee1@gmail.com') THEN
    ...
    -- 2. Insert into auth.identities (excluding generated email column)
