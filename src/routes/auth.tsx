    ...
    <div className="min-h-screen relative flex items-center justify-center px-4 py-12 gradient-mesh">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="relative w-full max-w-md">
        ...
        <Card className="p-8 rounded-3xl bg-card border text-card-foreground shadow-glow">
          {activationToken && (
            <div className="mb-5 rounded-md border border-brand/30 bg-brand/5 p-3 text-sm text-foreground">
              Votre paiement est validé. Créez ou connectez votre compte pour activer l'espace entreprise.
            </div>
          )}
          ...
          <p className="mt-2 text-center text-[11px] text-muted-foreground">L'identifiant employé sera demandé après Google. Votre email de connexion reste privé.</p>
